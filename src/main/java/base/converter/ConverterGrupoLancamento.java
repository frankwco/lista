...
public class ConverterGrupoLancamento implements Converter{
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
			 ...
			 return dao.buscarPorId(GrupoLancamento.class, Long.parseLong(value));
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (!(value instanceof GrupoLancamento)) return null;
		    return  String.valueOf(((GrupoLancamento) value).getId());
